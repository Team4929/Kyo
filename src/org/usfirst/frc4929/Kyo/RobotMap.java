...
public class RobotMap {
    ...
    public static SpeedController pullyMotorTopMo;
    public static DoubleSolenoid openDoubleSolenoid1;
    ...
    public static void init() {
        ...
        pullyMotorTopMo = new Talon(4);
        LiveWindow.addActuator("PullyMotor", "TopMo", (Talon) pullyMotorTopMo);
        
        openDoubleSolenoid1 = new DoubleSolenoid(0, 4, 5);      
        LiveWindow.addActuator("Open", "Double Solenoid 1", openDoubleSolenoid1);
